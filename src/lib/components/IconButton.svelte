<script lang="ts">
	...
	//we can get the button from the component as button variable is binded to the button and the we can focus on it as que component directly is not focusable
