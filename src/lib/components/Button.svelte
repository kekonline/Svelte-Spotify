<script lang="ts">
	...
	// defining component type to have autocomplete and type checking
	//with this depending of our prop and element type we can choose the correct type for a or button
